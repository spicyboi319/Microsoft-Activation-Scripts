   **Microsoft Activation Scripts (MAS):**
   ...
   with a focus on open-source code, less antivirus detection and user-friendliness. I recommend that you do not use the Online KMS version and instead use HWID or KMS38 instead. This fork removes the menu option for the online KMS in the all-in-one script and the standalone online activator. 
